...
/// `SNARKGens` holds public parameters for producing and verifying proofs with the LUMEN SNARK
...
/// `SNARK` holds a proof produced by LUMEN SNARK
...
/// `NIZKGens` holds public parameters for producing and verifying proofs with the LUMEN NIZK
pub struct NIZKGens {
  gens_r1cs_sat: R1CSGens,
}
...
/// `NIZK` holds a proof produced by LUMEN NIZK
#[derive(Serialize, Deserialize, Debug)]
pub struct NIZK {
  r1cs_sat_proof: R1CSProof,
