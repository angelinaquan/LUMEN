...
use ark_lumen::{Lumen, SimpleHashFiatShamirRng};
...
macro_rules! lumen_verify_bench {
    ($bench_name:ident, $bench_field:ty, $bench_pairing_engine:ty) => {
        let rng = &mut ark_std::test_rng();
        let c = DummyCircuit::<$bench_field> {
            a: Some(<$bench_field>::rand(rng)),
...
fn bench_prove() {
    lumen_prove_bench!(bls, BlsFr, Bls12_381);
    lumen_prove_bench!(mnt4, MNT4Fr, MNT4_298);
    lumen_prove_bench!(mnt6, MNT6Fr, MNT6_298);
    lumen_prove_bench!(mnt4big, MNT4BigFr, MNT4_753);
    lumen_prove_bench!(mnt6big, MNT6BigFr, MNT6_753);
}

fn bench_verify() {
    lumen_verify_bench!(bls, BlsFr, Bls12_381);
    lumen_verify_bench!(mnt4, MNT4Fr, MNT4_298);
    lumen_verify_bench!(mnt6, MNT6Fr, MNT6_298);
    lumen_verify_bench!(mnt4big, MNT4BigFr, MNT4_753);
    lumen_verify_bench!(mnt6big, MNT6BigFr, MNT6_753);
}
