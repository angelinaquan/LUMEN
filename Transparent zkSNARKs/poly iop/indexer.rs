...
use crate::iop::{
    ...
    iopForR1CS, Error, LabeledPolynomial,
};
use crate::Vec;
...
use crate::iop::constraint_systems::{
...
impl<F: PrimeField> IndexInfo<F> {
    /// The maximum degree of polynomial required to represent this index in the iop.
    pub fn max_degree(&self) -> usize {
        iopForR1CS::<F>::max_degree(self.num_constraints, self.num_variables, self.num_non_zero)
            .unwrap()
    }
}
